...
const LOCKER_DEBUG_MODE_SYMBOL$LWS = shared$LWS.SymbolFor('@@lockerDebugMode'); // This package is bundled by third-parties that have their own build time
...
if (shared$LWS.LOCKER_UNMINIFIED_FLAG) {
  ...
  const formatValue$LWS = function formatValue$LWS(__value$LWS) {
    ...
    if (typeof __value$LWS === 'number') {
      return shared$LWS.NumberIsFinite(__value$LWS) ? ['span', primitiveBlueColorStyleObject$LWS, __value$LWS] : ['span', primitiveBlueColorStyleObject$LWS, `${__value$LWS >= 0 ? '' : '-'}Infinity`];
    }
    ...
    if (typeof __value$LWS === 'string') {
      ...
      if (_length$LWS > MAX_STRING_DISPLAY$LWS) {
        const firstChunk$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoSlice, _string$LWS, [0, MID_STRING_DISPLAY$LWS]);
        const lastChunk$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoSlice, _string$LWS, [_length$LWS - MID_STRING_DISPLAY$LWS - 1, _length$LWS]);
        _string$LWS = firstChunk$LWS + shared$LWS.CHAR_ELLIPSIS + lastChunk$LWS;
      } // @TODO: Default single quotes on main header.
      //       Double quotes on body.


      return ['span', primitiveOrangeColorStyleObject$LWS, shared$LWS.JSONStringify(_string$LWS)];
    }

    if (shared$LWS.ArrayIsArray(__value$LWS)) {
      return ['span', {}, `Array(${__value$LWS.length})`];
    }

    if (shared$LWS.isObject(__value$LWS)) {
      return ['span', {}, `{${shared$LWS.CHAR_ELLIPSIS}}`];
    } // Symbol will be coerced to a string.


    return ['span', primitiveOrangeColorStyleObject$LWS, shared$LWS.StringCtor(__value$LWS)];
  }; // istanbul ignore next: currently unreachable via tests
  ...
  const formatHeader$LWS = function formatHeader$LWS(object$LWS, config$LWS) {
    ...
    const brand$LWS = shared$LWS.ReflectApply(shared$LWS.ObjectProtoToString, object$LWS, []);
    let _keys$LWS = shared$LWS.ObjectKeys(object$LWS);

    if (brand$LWS === shared$LWS.TO_STRING_BRAND_SYMBOL) {
      if (!shared$LWS.ReflectApply(shared$LWS.ArrayProtoIncludes, _keys$LWS, ['description'])) {
        shared$LWS.ReflectApply(shared$LWS.ArrayProtoUnshift, _keys$LWS, ['description']);
      }
    } else if (brand$LWS === shared$LWS.TO_STRING_BRAND_STRING) {
      const {
        length: _length$LWS
      } = object$LWS;
      _keys$LWS = shared$LWS.ReflectApply(shared$LWS.ArrayProtoFilter, _keys$LWS, [__key$LWS => {
        const _possibleIndex$LWS = typeof __key$LWS === 'string' ? +__key$LWS : -1;
        return _possibleIndex$LWS < 0 || _possibleIndex$LWS >= _length$LWS || !shared$LWS.NumberIsInteger(_possibleIndex$LWS);
      }]);
    }
    ...
    if (shared$LWS.ArrayIsArray(object$LWS)) {
      ...
      for (let _i$LWS = 0, _length$LWS = shared$LWS.MathMin(keysLength$LWS, MAX_ARRAY_DISPLAY$LWS); _i$LWS < _length$LWS; _i$LWS += 1) {
      ...
      if (keysLength$LWS > MAX_ARRAY_DISPLAY$LWS) {
        formattedHeader$LWS[formattedHeaderOffset$LWS++] = ['span', null, ['span', {}, `, ${shared$LWS.CHAR_ELLIPSIS}`]];
      }
    ...
    switch (brand$LWS) {
      case shared$LWS.TO_STRING_BRAND_BIG_INT:
      case shared$LWS.TO_STRING_BRAND_BOOLEAN:
      case shared$LWS.TO_STRING_BRAND_NUMBER:
      case shared$LWS.TO_STRING_BRAND_STRING:
      case shared$LWS.TO_STRING_BRAND_SYMBOL:
        {
          let colorStyleObject$LWS = primitiveBlueColorStyleObject$LWS;

          if (brand$LWS === shared$LWS.TO_STRING_BRAND_BIG_INT) {
            colorStyleObject$LWS = primitiveGreenColorStyleObject$LWS;
          } else if (brand$LWS === shared$LWS.TO_STRING_BRAND_SYMBOL) {
            colorStyleObject$LWS = primitiveOrangeColorStyleObject$LWS;
          }

          headerOpening$LWS = `${shared$LWS.ReflectApply(shared$LWS.StringProtoSlice, brand$LWS, [8, -1])} {`;
          boxedHeaderEntry$LWS = ['span', colorStyleObject$LWS, `${shared$LWS.StringCtor(shared$LWS.getNearMembraneSerializedValue(object$LWS))}`];
          break;
        }
    }
    ...
    for (let _i$LWS = 0, _length$LWS = shared$LWS.MathMin(keysLength$LWS, MAX_OBJECT_DISPLAY$LWS); _i$LWS < _length$LWS; _i$LWS += 1) {
      const __key$LWS = _keys$LWS[_i$LWS];
      const __value$LWS = object$LWS[__key$LWS];
      formattedHeader$LWS[formattedHeaderOffset$LWS++] = ['span', {}, _i$LWS ? ', ' : ''];
  ...
  const formatBody$LWS = function formatBody$LWS(object$LWS) {
    const _keys$LWS = shared$LWS.ObjectKeys(object$LWS); // @TODO: Arrays are broken into groups of 100.

    const ownKeys$LWS = shared$LWS.ReflectOwnKeys(object$LWS);

    if (!shared$LWS.ArrayIsArray(object$LWS)) {
      shared$LWS.ReflectApply(shared$LWS.ArrayProtoSort, ownKeys$LWS, []);
    }
    ...
    for (let _i$LWS = 0, {
      ...
      if (shared$LWS.isObject(__value$LWS)) {
        formattedBody$LWS[formattedBodyOffset$LWS++] = ['div', {}, ['object', {
          object: __value$LWS,
          config: {
            childKey: shared$LWS.StringCtor(ownKey$LWS),
            isChildElement: true
          }
        }]];
      } else {
        ...
        if (typeof ownKey$LWS === 'symbol' || !shared$LWS.ReflectApply(shared$LWS.ArrayProtoIncludes, _keys$LWS, [ownKey$LWS])) {
          currentKeyStyle$LWS = keyNonEnumerableOrSymbolStyleObject$LWS;
        }

        formattedBody$LWS[formattedBodyOffset$LWS++] = ['div', bodyItemStyleObject$LWS, ['span', currentKeyStyle$LWS, shared$LWS.StringCtor(ownKey$LWS)], ['span', {}, ': '], formatValue$LWS(__value$LWS)];
      }
    }
  ...
  if (!shared$LWS.ArrayIsArray(devtoolsFormatters$LWS)) {
    devtoolsFormatters$LWS = [];
    shared$LWS.ReflectDefineProperty(window, 'devtoolsFormatters', {
      __proto__: null,
      configurable: true,
  ...
  devtoolsFormatters$LWS[devtoolsFormatters$LWS.length] = {
    ...
    header(object$LWS, config$LWS) {
      if (lockerDebugModeSymbolFlag$LWS) {
        ...
        shared$LWS.ReflectDefineProperty(window, LOCKER_DEBUG_MODE_SYMBOL$LWS, {
          __proto__: null,
          configurable: true,
          value: true,
          writable: true
      ...
      if (!shared$LWS.isNearMembrane(object$LWS)) {
        return null;
      }
      ...
      shared$LWS.ReflectApply(shared$LWS.ArrayProtoPush, headerDiv$LWS, formatHeader$LWS(object$LWS, config$LWS));
    ...
    body(object$LWS) {
      ...
      shared$LWS.ReflectApply(shared$LWS.ArrayProtoPush, bodyDiv$LWS, formatBody$LWS(object$LWS));
      return bodyDiv$LWS;
    }
...
const normalizerAnchor$LWS = shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoCreateElement, document, ['a']); // @TODO W-7302311 Make paths and domains configurable
...
function initDistortionEval$LWS({
  ...
  return function distortionEval$LWS({
    ...
    return [originalEval$LWS, sourceText$LWS => sandboxEvaluator$LWS(sharedDom$LWS.transformUncompiledSourceText(shared$LWS.toString(sourceText$LWS)), UNCOMPILED_CONTEXT$LWS)];
  };
...
} = sharedDom$LWS.selfValidator; // The outerText property is non-standard, so the descriptor could be undefined,
...
function defineSrcEvaluatorProperty$LWS(host$LWS, sandboxEvaluator$LWS) {
  ...
  defineEvaluatorProperty$LWS(host$LWS, (context$LWS, defaultView$LWS, ownerDoc$LWS, {
    ...
    sandboxEvaluator$LWS(sharedDom$LWS.transformUncompiledSourceText(sharedDom$LWS.WindowDecodeURIComponent(shared$LWS.toString(encodedPayload$LWS))), context$LWS, defaultView$LWS, ownerDoc$LWS);
  });
  return true;
}
...
function defineTextContentEvaluatorProperty$LWS(host$LWS, textContent$LWS, sandboxEvaluator$LWS) {
  ...
  defineEvaluatorProperty$LWS(host$LWS, (context$LWS, defaultView$LWS, ownerDoc$LWS) => {
    sandboxEvaluator$LWS(sharedDom$LWS.transformUncompiledSourceText(textContent$LWS), context$LWS, defaultView$LWS, ownerDoc$LWS);
  });
  return true;
}
...
function createScriptDistortion$LWS({
  ...
  const {
    ...
    [distortionName$LWS](value$LWS) {
      ...
      value$LWS = shared$LWS.ReflectApply(sharedDom$LWS.HTMLAnchorElementProtoHrefGetter, normalizerAnchor$LWS, []); // Create a dataset attribute to expose the undistorted attribute value.
      ...
      if (shared$LWS.ReflectApply(shared$LWS.RegExpProtoTest, TRUSTED_DOMAINS_REG_EXP$LWS, [hostname$LWS])) {
...
function initDistortionNavigatorSendBeacon$LWS({
  ...
  const distortionEntry$LWS = [originalSendBeacon$LWS, function sendBeacon$LWS(...args$LWS) {
    if (args$LWS.length) {
      const parsedURL$LWS = parseURL$LWS(shared$LWS.toString(args$LWS[0]));
  ...
  const distortionEntry$LWS = [originalFetch$LWS, function fetch$LWS(...args$LWS) {
    ...
    if (url$LWS !== null && url$LWS !== undefined) {
      ...
      if (url$LWS instanceof Request) {
        ...
        parsedURL$LWS = parseURL$LWS(shared$LWS.ReflectApply(sharedDom$LWS.RequestProtoURLGetter, url$LWS, []));
      } else {
        parsedURL$LWS = parseURL$LWS(shared$LWS.toString(url$LWS));
        ...
        if (callback$LWS !== null && callback$LWS !== undefined && typeof callback$LWS !== 'function') {
          ...
          args$LWS[0] = () => {
            if (transformedSourceText$LWS === undefined) {
              transformedSourceText$LWS = sharedDom$LWS.transformUncompiledSourceText(sourceText$LWS);
            }
      ...
      if (args$LWS.length) {
        ...
        if (callback$LWS !== null && callback$LWS !== undefined && typeof callback$LWS !== 'function') {
          ...
          args$LWS[0] = () => {
            ...
            sandboxEvaluator$LWS(sharedDom$LWS.transformUncompiledSourceText(sourceText$LWS), UNCOMPILED_CONTEXT$LWS);
          };
        }
      }
...
function initDistortionXMLHttpRequestOpen$LWS({
  ...
  const distortionEntry$LWS = [originalOpen$LWS, function open$LWS(...args$LWS) {
    ...
    if (url$LWS !== null && url$LWS !== undefined) {
      const parsedURL$LWS = parseURL$LWS(shared$LWS.toString(url$LWS));
...
const SUPPORTS_DISTORTIONS_WEAK_MAP$LWS = (() => {
  ...
  if ( // While experimental, `navigator.userAgentData.brands` may be defined
  // as an empty array in headless Chromium based browsers.
  shared$LWS.ArrayIsArray(brands$LWS) && brands$LWS.length ? // Use user-agent client hints API if available to avoid
  // deprecation warnings.
  // https://developer.mozilla.org/en-US/docs/Web/API/User-Agent_Client_Hints_API
...
const {
  ...
  top: topWindow$LWS
} = sharedDom$LWS.selfWindow; // Fast path non-configurable document, location, and window objects in the
// virtual environment distortion callback by seeding them in the top window's
// created distortion map.

const selfDistortionMapSeedEntries$LWS = [[sharedDom$LWS.selfDocument, sharedDom$LWS.selfDocument], [selfLocation$LWS, selfLocation$LWS], [sharedDom$LWS.selfWindow, sharedDom$LWS.selfWindow]];
const selfSandboxRegistry$LWS = {
  __proto__: null
};
const documentToSandboxRegistry$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor([[sharedDom$LWS.selfDocument, selfSandboxRegistry$LWS]]));
const documentToDistortionFactoriesMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
...
const TOP_UNCOMPILED_CONTEXT$LWS = {
  [shared$LWS.UNCOMPILED_LOCATION_NAME]: selfLocation$LWS,
  [shared$LWS.UNCOMPILED_TOP_NAME]: topWindow$LWS
};
...
function createDistortionMap$LWS(entries$LWS) {
  ...
  shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor(entries$LWS)) : shared$LWS.toSafeMap(new shared$LWS.MapCtor(entries$LWS));
}
  ...
  return _sourceText$LWS => {
    if (lazyVirtualEnvironmentEvaluator$LWS === undefined) {
      ...
      setEvalContext$LWS(redHelpersFactory$LWS => {
        shared$LWS.ObjectAssign(_record$LWS.helpers, redHelpersFactory$LWS({
          elementToLoadingPromiseMap: elementToLoadingPromiseMap$LWS
        }));
      });
...
function createWindowSandboxRecord$LWS({
  ...
  _record$LWS = {
    ...
    context: _context$LWS,
    document: sharedDom$LWS.selfDocument,
    distortions: distortions$LWS,
    endowments: endowments$LWS,
    globalObject: sharedDom$LWS.selfWindow,
    helpers: createEvalHelpersObject$LWS(),
    instrumentation: instrumentation$LWS,
    key: __key$LWS,
    sandboxEvaluator: shared$LWS.noop,
...
function internalEvaluateInSandbox$LWS(evaluateOptions$LWS) {
  ...
  } = _globalObject$LWS === sharedDom$LWS.selfWindow ? createWindowSandboxRecord$LWS({
    context: _context$LWS,
    endowments: endowments$LWS,
    instrumentation: instrumentation$LWS,
    key: __key$LWS,
