...
// packages/@lwrjs/nunjucks-view-provider/src/nunjucks-env-utils.ts
__markAsModule(exports);
__export(exports, {
  NunjucksCustomLoader: () => NunjucksCustomLoader,
  addHelperMethods: () => addHelperMethods
});
...
var NunjucksCustomLoader = class extends import_nunjucks.Loader {
  ...
  getSource(templatePath) {
    ...
    const src = import_fs.default.readFileSync(fullTemplatePath, "utf-8");
